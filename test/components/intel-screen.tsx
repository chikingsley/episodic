      ...
      {showSettingsModal && (
        <div className="fixed inset-0 bg-black bg-opacity-95 z-50 flex flex-col">
          ...
          <div className="flex-1 overflow-auto px-4 py-2">
            ...
            <div className="bg-gray-900 border border-red-900 rounded overflow-hidden mb-6">
              <div className="border-b border-red-900/30">
                <div className="p-4 flex items-center justify-between">
                  <span className="font-mono text-gray-300">INTELLIGENCE FILTERS</span>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-red-500">
              ...
              <div className="border-b border-red-900/30">
                <div className="p-4 flex items-center justify-between">
                  <span className="font-mono text-gray-300">DATA SORTING</span>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-red-500">
                    <polyline points="9 18 15 12 9 6"></polyline>
                  </svg>
                </div>
              ...
              <div>
                <div className="p-4 flex items-center justify-between">
                  <span className="font-mono text-gray-300">PRIORITY TARGETS</span>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-red-500">
                    <polyline points="9 18 15 12 9 6"></polyline>
                  </svg>
                </div>
            ...
            {/* Advanced Settings */}
            <h3 className="text-red-500 uppercase text-xs font-bold font-mono tracking-wider mb-3">ADVANCED PROTOCOLS</h3>
            <div className="bg-gray-900 border border-red-900 rounded overflow-hidden mb-6">
              <div className="border-b border-red-900/30">
                <div className="p-4 flex items-center justify-between">
                  <span className="font-mono text-gray-300">DATA ENCRYPTION</span>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-red-500">
                    <polyline points="9 18 15 12 9 6"></polyline>
                  </svg>
                </div>
              ...
              <div>
                <div className="p-4 flex items-center justify-between">
                  <span className="font-mono text-gray-300">SECURE TRANSMISSION</span>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-red-500">
                    <polyline points="9 18 15 12 9 6"></polyline>
                  </svg>
                </div>
